...
const createPrincipalCard = (centerSection, id, principalImage, profileImage1, profileImage2, author, date, title, hashtags) =>{
    ...
    const taipyLogoImage = createHTMLElement('img', null, [['alt', 'taipy logo'], ['src', profileImage1]]);
    const profileDiv = createHTMLElement('div', ['profile']);
    const profileImg = createHTMLElement('img', null, [['src', profileImage2], ['alt', 'profile']]);
...
export { createHTMLElement, createPrincipalCard };
